...
### 2.4 Tracking
- `tracking/bytetrack_engine.py`: scaffold adapter
...
- `tracking/tracking_service.py`: tích hợp logic tracking
...
### Giới hạn minh bạch
- Tracking hiện là scaffold adapter (chưa production ByteTrack đầy đủ)
- UI hiện là console skeleton (chưa PyQt dashboard hoàn chỉnh)
- KPI hiện là proxy runtime, chưa gắn bộ GT production đầy đủ

---

## 6) Hướng cải tiến mở rộng (sau nghiệm thu PoC)

1. Thay tracker scaffold bằng runtime tracker production.
